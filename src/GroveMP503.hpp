...
class GroveMP503 {
  ...
  public:
    ...
    GroveMP503Data readAirQuality() {
      ...
      if (data.voltage <= 1000) data.quality = "Bardzo dobre";
      else if (data.voltage <= 1500) data.quality = "Dobre";
      else if (data.voltage <= 2000) data.quality = "Srednie";
      else if (data.voltage <= 2500) data.quality = "Zle";
      else data.quality = "Bardzo złe";
